...
async function main() {
  ...
  // To check LinkToken balance in your account, change the param to 'keyring.toAccount()._address'
  contract.methods.balanceOf(fs.readFileSync("./contract/oracle_timestamp-contractAddress.bin").toString()).call({
